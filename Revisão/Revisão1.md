# Revisão 1 - Números complexos, álgegra linear e operações quânticas fundamentais

## Números Complexos

**1.** Defina o que é um número complexo e escreva um exemplo na forma $z = a + bi$.

**2.** Dado o número complexo $z = 3 + 2i$, identifique:
- a parte real
- a parte imaginária

**3.** Considere $z = -4 + 5i$. Determine:
- Re(z)
- Im(z)

**4.** Verifique se os números complexos são iguais:
$z_1 = 2 + 3i$ e $z_2 = 2 + 3i$

**5.** Verifique se os números complexos são iguais:
$z_1 = 1 + 4i$ e $z_2 = 1 - 4i$

**6.** Determine o conjugado do número complexo:
$z = 5 + 2i$

**7.** Determine o conjugado do número complexo:
$z = -3 - i$

**8.** Calcule o produto do número complexo pelo seu conjugado:
$z = 2 + 3i$

**9.** Calcule o módulo do número complexo:
$z = 3 + 4i$

**10.** Calcule o módulo do número complexo:
$z = 1 + 2i$

**11.** Efetue a adição:
$(2 + 3i) + (4 + i)$

**12.** Efetue a subtração:
$(5 + 2i) - (1 + i)$

**13.** Efetue a multiplicação:
$(2 + i)(3 + i)$

**14.** Efetue a multiplicação:
$(1 + 2i)(2 - i)$
...
**46.** Defina o que é um qubit e explique a principal diferença em relação a um bit clássico.

**47.** Escreva o estado de um qubit na forma geral:
$|\psi\rangle = \alpha|0\rangle + \beta|1\rangle$

**48.** Considere o estado:
$|\psi\rangle = 2|0\rangle + 3|1\rangle$
Identifique os coeficientes $\alpha$ e $\beta$.

**49.** Escreva os estados base de um qubit na notação bra-ket.

**50.** Represente os estados $|0\rangle$ e $|1\rangle$ como vetores coluna.

**51.** Considere o estado:
$|\psi\rangle = |0\rangle + |1\rangle$
Escreva esse estado na forma de vetor coluna.

**52.** Considere o estado:
$|\psi\rangle = 3|0\rangle + |1\rangle$
...
**69.** Escreva as matrizes dos operadores de Pauli $X$, $Y$ e $Z$.

**70.** Aplique o operador $X$ ao estado $|0\rangle$.

**71.** Aplique o operador $X$ ao estado $|1\rangle$.

**72.** Aplique o operador $Z$ ao estado $|0\rangle$.

**73.** Aplique o operador $Z$ ao estado $|1\rangle$.

**74.** Aplique o operador $Y$ ao estado $|0\rangle$.
